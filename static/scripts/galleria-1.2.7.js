...
// internal constants
    VERSION = 1.28, // Es la versión 1.27 truco por lo del bug de plone <.<
    DEBUG = true,
    TIMEOUT = 30000,
    DUMMY = false,
    ...
    _createThumbnails : function() {
        ...
        for( i = 0; this._data[ i ]; i++ ) {
            ...
            if ( o.thumbnails === true && (data.thumb || data.image) ) {
				...
				// NEW CODE TO GET TITLE TO APPEAR UNDER THUMBNAILS
				$(thumb.container).append($( Utils.create('galleria-thumbDesc')).html(data.title).show());
    ...
    */
    ...
    load : function( source, selector, config ) {
        ...
        $( source ).find( selector ).each( function( i, elem ) {
            ...
            $.each( 'big title description link layer thumbDesc'.split(' '), function( i, val ) {
               if ( elem.data(val) ) {
