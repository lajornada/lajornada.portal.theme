...
#from lajornada.portal.theme import _
...
class IRecentVideos(IPortletDataProvider):
    ...
    tag = schema.TextLine(title=u'Tag',
                          description=u"Tag to filter the videos ",
                          required=True)

    limit = schema.Int(title=u"Limit",
                       description=u"The maximum results number.",
                       required=True,
                       default=5)
